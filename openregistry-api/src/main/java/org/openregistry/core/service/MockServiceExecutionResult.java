 ...
 *
 * @since 1.0
 * @see ServiceExecutionResult
 *
 */
public class MockServiceExecutionResult<T> implements ServiceExecutionResult<T> {
    ...
    public MockServiceExecutionResult(final String serviceName, final T targetObject) {
        this(serviceName, targetObject, null);
    }

    public MockServiceExecutionResult(final String serviceName, final List<ValidationError> validationErrors) {
        this(serviceName, null, validationErrors);
    }

    public MockServiceExecutionResult(final String serviceName, final T targetObject, final List<ValidationError> validationErrors) {
