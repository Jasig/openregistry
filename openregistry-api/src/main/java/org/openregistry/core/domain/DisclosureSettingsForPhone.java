...
/**
 * A set of settings that regulates which information about a telephone number
 * can be publicly disclosed
 * @author lidial 
 * @version $Revision$ $Date$
 * @since 1.0.0
 */
public interface DisclosureSettingsForPhone {

	/** Unique identifier */
	public Long getId();
	
	/** The type of phone number this setting should apply to */
	public Type getPhoneType();
	
	/** The type of address this setting should apply to */
	public Type getAddressType();

	/** Returns affiliation as String */
	public String getAffiliation();

	/** Returns true if this phone number should be public */
	boolean getPublicInd();
	
	/** Returns the date when the disclosure setting was last updated */
	Date getPublicIndDate();
	
	/** Controls whether the phone number should be public; sets the last update date to the current date */
	void setPublicInd(boolean isPublic);
	
	/** Controls whether the phone number should be public and sets the last update date*/
	void setPublicInd(boolean isPublic, Date updateDate);
	
	/** Returns true id the address type, phone type and affiliation for this object match supplied values */
