...
/**
 * A set of settings that regulates which information about an email address
 * can be publicly disclosed
 * @author lidial 
 * @version $Revision$ $Date$
 * @since 1.0.0
 */
public interface DisclosureSettingsForEmail {
    
	/** Unique identifier */
	public Long getId();
	
	/** The type of email this setting should apply to */
	public Type getType();
	
	/** Returns affiliation as String */
	public String getAffiliation();

	/** Returns true if this email address should be public */
	boolean getPublicInd();
	
	/** Returns the date when the disclosure setting was last updated */
	Date getPublicIndDate();
	
	/** Controls whether the email address should be public; sets the last update date to the current date */
	void setPublicInd(boolean isPublic);
	
	/** Controls whether the email address should be public and sets the last update date*/
