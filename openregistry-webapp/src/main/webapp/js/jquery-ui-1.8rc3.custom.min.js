...
(function(a) {
    ...
    a.extend(a.ui.draggable, {version:"1.8rc3"});
...
(function(a) {
    ...
    a.extend(a.ui.droppable, {version:"1.8rc3"});
...
(function(c) {
    ...
    c.extend(c.ui.resizable, {version:"1.8rc3"});
...
(function(a) {
    ...
    a.extend(a.ui.selectable, {version:"1.8rc3"})
})(jQuery);
;
/*
...
(function(a) {
    ...
    a.extend(a.ui.sortable, {version:"1.8rc3"})
})(jQuery);
;
/*
...
(function(a) {
    ...
    a.extend(a.ui.accordion, {version:"1.8rc3",animations:{slide:function(j, h) {
...
(function(a) {
    a.widget("ui.autocomplete", {options:{minLength:1,delay:300},_create:function() {
        ...
        this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off").attr({role:"textbox","aria-autocomplete":"list","aria-haspopup":"true"}).bind("keydown.autocomplete", function(c) {
            var d = a.ui.keyCode;
            switch (c.keyCode) {case d.PAGE_UP:b._move("previousPage", c);break;case d.PAGE_DOWN:b._move("nextPage", c);break;case d.UP:b._move("previous", c);c.preventDefault();break;case d.DOWN:b._move("next", c);c.preventDefault();break;case d.ENTER:if (b.menu.active) {
                c.preventDefault()
            }case d.TAB:if (!b.menu.active) {
                return
            }b.menu.select();break;case d.ESCAPE:b.element.val(b.term);b.close(c);break;case 16:case 17:case 18:break;default:clearTimeout(b.searching);b.searching = setTimeout(function() {
                b.search(null, c)
...
(function(b) {
    ...
    b.widget("ui.slider", b.ui.mouse, {widgetEventPrefix:"slide",options:{animate:false,distance:0,max:100,min:0,orientation:"horizontal",range:false,step:1,value:0,values:null},_create:function() {
        ...
        }case"orientation":this._detectOrientation();this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addClass("ui-slider-" + this.orientation);this._refreshValue();break;case"value":this._animateOff = true;this._refreshValue();this._animateOff = false;break;case"values":this._animateOff = true;this._refreshValue();this._animateOff = false;break
        }
    },_step:function() {
    ...
    b.extend(b.ui.slider, {version:"1.8rc3"})
})(jQuery);
;
/*
...
jQuery.effects || (function(g) {
    ...
    g.extend(g.effects, {version:"1.8rc3",save:function(l, m) {
