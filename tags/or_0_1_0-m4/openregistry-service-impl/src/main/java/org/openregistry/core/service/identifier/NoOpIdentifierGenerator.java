...
public final class NoOpIdentifierGenerator implements IdentifierGenerator {
    ...
    public long generateNextLong() {
        return this.incrementalValue.incrementAndGet();
    }

    public String generateNextString() {
        return String.valueOf(this.incrementalValue.incrementAndGet());
    }

    public int generateNextInt() {
        return Integer.parseInt(String.valueOf(this.incrementalValue.incrementAndGet()));
    }
}
