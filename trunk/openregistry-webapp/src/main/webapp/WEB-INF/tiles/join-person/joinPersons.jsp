...
<form:form modelAttribute="person">
    ...
    <fieldset class="fm-h" id="ecn1">
		...
		<div class="row fm-v" style="clear:both;">
            <input style="float:left;" type="submit" id="fm-continue-submit1" name="_eventId_continue" class="btn-submit" value="Continue" tabindex="11"/>
			<input style="float:left;" type="submit" id="fm-cancel-submit1" name="_eventId_cancel" class="btn-submit" value="Cancel" tabindex="12"/>
		</div>
