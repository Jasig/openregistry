...
<form:form modelAttribute="reconciliationCriteria" commandName="reconciliationCriteria" method="post">
	<div style="margin:5px;">
		<legend><div class="or-section-title1"><spring:message code="addPersonPage.heading" /></div></legend>
		...
		<div class="field_set group">
			...
			<div>
				...
				<form:input path="sorPerson.names[0].given"  size="10" maxlength="30" tabindex="2" cssErrorClass="fieldError" cssClass="fl-textfield"/>
			</div>
			<div>
				...
				<form:input path="sorPerson.names[0].middle" size="10" maxlength="30" tabindex="3" cssErrorClass="fieldError" cssClass="fl-textfield"/>
			</div>
			<div>
				...
				<form:input path="sorPerson.names[0].family" size="10" maxlength="30" tabindex="4" cssErrorClass="fieldError"  cssClass="fl-textfield"/>
			</div>
			<div>
				...
				<form:input path="sorPerson.names[0].suffix" size="10" maxlength="30" tabindex="4" cssErrorClass="fieldError"  cssClass="fl-textfield"/>
			</div>
		</div>
		<div class="field_set group">
			<div class="padded">
			...
			<div class="padded">
				...
				<form:input path="sorPerson.dateOfBirth" size="10" maxlength="10" tabindex="7" cssErrorClass="fieldError" placeholder="yyyy-mm-dd" cssClass="fl-textfield"/>
			</div>

			<div class="padded">
				<form:label  cssClass="above" path="sorPerson.ssn" cssErrorClass="labelError"><spring:message code="ssn.label" /></form:label>
				<form:input path="sorPerson.ssn"  size="9" maxlength="9" tabindex="8" cssErrorClass="fieldError" cssClass="fl-textfield"/>
			</div>

			<div class="padded">
				<form:label cssClass="above" path="emailAddress" cssErrorClass="labelError"><spring:message code="email.label" /></form:label>
				<form:input path="emailAddress" size="20" maxlength="30" tabindex="9" cssErrorClass="fieldError" cssClass="fl-textfield"/>
			</div>

			<div class="padded">
				<form:label cssClass="above" path="phoneNumber" cssErrorClass="labelError"><spring:message code="phoneNumber.label" /></form:label>
				<form:input path="phoneNumber" size="15" maxlength="15" tabindex="10" cssErrorClass="fieldError" cssClass="fl-textfield"/>
			</div>
		</div>
